...
void MqttHandlePowerLimiterHassClass::publishConfig()
{
    ...
    publishNumber("Storage Target Export Offset", "mdi:transmission-tower-export", "config", "target_power_consumption_storage_offset", "target_power_consumption_storage_offset", "W", 0, 32767, 1);
