# FluxDTU GitHub Copilot Instructions

**ALWAYS follow these instructions first and only fallback to additional search and context gathering if the information here is incomplete or found to be in error.**

FluxDTU is an ESP32-based firmware project that provides solar inverter monitoring and battery management with a web interface. The project combines C++ ESP32 firmware with a Vue.js web application that gets embedded into the firmware.
