...
protected:
    ...
    {
        return _oTargetPowerLimitWatts.value_or(getCurrentLimitWatts());
    }
...
private:
    static constexpr uint32_t _assumeTargetReachedAfterMillis = 3 * 1000;
    ...
    void recordSuccessfulTargetCommand(uint32_t commandMillis);
