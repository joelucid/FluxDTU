...
public:
    ...
    static uint32_t constexpr DataRequestIntervalMillis = 1000;
...
private:
    ...
    static uint32_t normalizeValueId(uint32_t valueId);
    void loop();
    void processQueue();
    ...
    static constexpr uint32_t DeviceConfigTimeoutMillis = DataRequestIntervalMillis * 10;
