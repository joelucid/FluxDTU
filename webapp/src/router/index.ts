...
import OperationProfilesAdminView from '@/views/OperationProfilesAdminView.vue';
...
const router = createRouter({
    ...
    routes: [
        ...
        {
            path: '/settings/operationprofiles',
            name: 'Operation Profiles',
            component: OperationProfilesAdminView,
        },
        {
