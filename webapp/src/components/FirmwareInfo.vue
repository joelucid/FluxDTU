            ...
            <table class="table table-hover table-condensed">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ systemStatus.config_version }}-FluxDTU-{{ systemStatus.config_version_onbattery }}</td>
                    </tr>
                    <tr>
    ...
    computed: {
        ...
        versionInfoUrl(): string {
            if (this.systemStatus.git_is_hash) {
                return 'https://github.com/joelucid/FluxDTU/commits/' + this.systemStatus.git_hash;
            }
            return 'https://github.com/joelucid/FluxDTU/releases/tag/' + this.systemStatus.git_hash;
        },
    },
});
</script>
