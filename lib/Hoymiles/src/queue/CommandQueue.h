...
public:
    ...
    void removeDuplicatedEntries(std::shared_ptr<CommandAbstract> cmd, bool preserveFront);
    void replaceEntries(std::shared_ptr<CommandAbstract> cmd, bool preserveFront);
