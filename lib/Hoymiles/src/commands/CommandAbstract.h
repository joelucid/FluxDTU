...
public:
    ...
    // Sets the amount of NRF hardware auto retransmits while waiting for auto ACK.
    virtual uint8_t getHardwareRetryCount() const { return 15; }
    ...
    virtual bool isCompleteOnTxSuccess() const { return false; }
