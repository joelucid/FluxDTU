...
public:
    ...
    virtual bool isCompleteOnTxSuccess() const { return true; }
    virtual uint8_t getMaxResendCount() const { return 20; }
    virtual uint8_t getHardwareRetryCount() const { return 8; }
